...
<!-- SREDNOFF-OS:SELECTION -->
> **SREDNOFF OS - skills for this project** (full list: .claude/PROFILE.lock.md - read it first) | tags: web, frontend, infra, devops | top: vercel:bootstrap, ui-ux-pro-max, frontend-design:frontend-design, vercel:nextjs, vercel:shadcn, vercel:ai-sdk, vercel:auth, vercel:env
<!-- /SREDNOFF-OS:SELECTION -->
